...
class sfDate
{
	 ...
	 * @return	sfDate
	 */
	public static function getInstance($ts = null)
	{
	...
	public function datetime()
	{
		...
		return format_datetime($this->ts);
	}
	 ...
	 *
	 * @param	string	unit of time (accepts sfTime constants).
	 ...
	 */
	public function diff($ts)
	{
		$dt = new sfDate($ts);
		
		return $this->ts - $dt->get();
	}
