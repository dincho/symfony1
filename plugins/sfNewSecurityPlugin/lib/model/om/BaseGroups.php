...
abstract class BaseGroups extends BaseObject  implements Persistent {
	...
	{
				include_once 'plugins/sfNewSecurityPlugin/lib/model/om/BasePermissionsPeer.php';
		if ($criteria === null) {
	...
	{
				include_once 'plugins/sfNewSecurityPlugin/lib/model/om/BaseGroupAndActionPeer.php';
		if ($criteria === null) {
			$criteria = new Criteria();
		}
		elseif ($criteria instanceof Criteria)
