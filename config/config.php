...
//$sf_symfony_data_dir = 'C:\_symfony_installed_\symfony-1.0.19\symfony-1.0.19\data';

if( !defined('SALT') ) define('SALT', 'fj`Jbu6`r7XFvC$V@<%3l#lE/K/J\;Ai');
if( !defined('BASE_URL') ) define('BASE_URL', 'http://pd.dincho.bonex.us/');