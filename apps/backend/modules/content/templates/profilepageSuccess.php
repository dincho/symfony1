...
<?php echo form_tag('content/profilepage', 'class=form') ?>
    ...
    <fieldset class="form_fields error_msgs_fields">
        ...
        <label>upgrade to use</label><?php echo input_tag('trans[137]', (isset($trans[137])) ? $trans[137]->getTarget() : null) ?><br />
        <label>upgrade to send</label><?php echo input_tag('trans[86]', (isset($trans[86])) ? $trans[86]->getTarget() : null) ?><br />
        <label>send limit</label><?php echo input_tag('trans[124]', (isset($trans[124])) ? $trans[124]->getTarget() : null) ?><br />
        <label>upgrade to read</label><?php echo input_tag('trans[125]', (isset($trans[125])) ? $trans[125]->getTarget() : null) ?><br />        
        <label>read limit</label><?php echo input_tag('trans[77]', (isset($trans[77])) ? $trans[77]->getTarget() : null) ?><br />
        <label>upgrade to reply</label><?php echo input_tag('trans[78]', (isset($trans[78])) ? $trans[78]->getTarget() : null) ?><br />
        <label>reply limit</label><?php echo input_tag('trans[81]', (isset($trans[81])) ? $trans[81]->getTarget() : null) ?><br />
        <label>upgrade to post upload</label><?php echo input_tag('trans[82]', (isset($trans[82])) ? $trans[82]->getTarget() : null) ?><br />        
        <label>post photo limit</label><?php echo input_tag('trans[115]', (isset($trans[115])) ? $trans[115]->getTarget() : null) ?><br />
        <label>upgrade to see viewers</label><?php echo input_tag('trans[116]', (isset($trans[116])) ? $trans[116]->getTarget() : null) ?><br />
        <label>upgrade to contact assistant</label><?php echo input_tag('trans[84]', (isset($trans[84])) ? $trans[84]->getTarget() : null) ?><br />
        <label>contact assistant limit</label><?php echo input_tag('trans[87]', (isset($trans[87])) ? $trans[87]->getTarget() : null) ?><br />
        <label>upgrade to wink</label><?php echo input_tag('trans[88]', (isset($trans[88])) ? $trans[88]->getTarget() : null) ?><br />
        ...
        <label>upgrade to send</label><?php echo input_tag('trans[126]', (isset($trans[126])) ? $trans[126]->getTarget() : null) ?><br />
        <label>send limit</label><?php echo input_tag('trans[127]', (isset($trans[127])) ? $trans[127]->getTarget() : null) ?><br />        
        <label>upgrade to read</label><?php echo input_tag('trans[120]', (isset($trans[120])) ? $trans[120]->getTarget() : null) ?><br />
        <label>read limit</label><?php echo input_tag('trans[121]', (isset($trans[121])) ? $trans[121]->getTarget() : null) ?><br />
        <label>upgrade to reply</label><?php echo input_tag('trans[122]', (isset($trans[122])) ? $trans[122]->getTarget() : null) ?><br />
        <label>reply limit</label><?php echo input_tag('trans[123]', (isset($trans[123])) ? $trans[123]->getTarget() : null) ?><br />
        <label>upgrade to post upload</label><?php echo input_tag('trans[128]', (isset($trans[128])) ? $trans[128]->getTarget() : null) ?><br />
        <label>post photo limit</label><?php echo input_tag('trans[129]', (isset($trans[129])) ? $trans[129]->getTarget() : null) ?><br />
        <label>upgrade to see viewers</label><?php echo input_tag('trans[130]', (isset($trans[130])) ? $trans[130]->getTarget() : null) ?><br />
        <label>upgrade to contact assistant</label><?php echo input_tag('trans[131]', (isset($trans[131])) ? $trans[131]->getTarget() : null) ?><br />
        <label>contact assistant limit</label><?php echo input_tag('trans[132]', (isset($trans[132])) ? $trans[132]->getTarget() : null) ?><br />
        <label>upgrade to wink</label><?php echo input_tag('trans[133]', (isset($trans[133])) ? $trans[133]->getTarget() : null) ?><br />
