...
<?php echo form_tag('content/profilepage', 'class=form') ?>
    ...
    <div class="tab_menu">
        <a class="selected" href="#" onClick="javascript:activateTab(this, 'tab1')">Message Panel 1</a> |
        <a href="#" onClick="javascript:activateTab(this, 'tab2')">Message Panel 2</a> |
        <a href="#" onClick="javascript:activateTab(this, 'tab3')">Error Messages</a> |
        <a href="#" onClick="javascript:activateTab(this, 'tab4')">To Standard Members</a> |
        <a href="#" onClick="javascript:activateTab(this, 'tab5')">To Premium Members</a> |
        <a href="#" onClick="javascript:activateTab(this, 'tab6')">To VIP Members</a>
    </div>
    ...
    <fieldset class="form_fields" id="labels_120">
        ...
        <div id="tab4" class="error_msgs_fields hidden js-tab">
        ...
        <div id="tab5" class="error_msgs_fields hidden js-tab">
        ...
        <div id="tab6" class="error_msgs_fields hidden js-tab">
...
<script>
function activateTab(el, pageId)
{
    var siblings = el.parentNode.childNodes;

    for (var j = 0; j < siblings.length; j++) {
        if (siblings[j].tagName == "A")
            siblings[j].className = ""
    }

    el.className = 'selected';

    var divs = document.forms[0].getElementsByClassName('js-tab');
