...
<div id="bottom_menu" class="bottom_menu">
  ...
  <?php if( isset($multiCatalogs) ): ?>
    <span class="bottom_menu_title multi_save">Also Save For:</span>
      <?php echo select_tag('affected_catalogs', objects_for_select($catalogs, 'getCatId', '__toString', $sf_request->getParameter('cat_id')), 'multiple = true'); ?>
    <?php endif; ?>
</div>
