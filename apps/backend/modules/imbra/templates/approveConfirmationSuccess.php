...
<fieldset class="form_fields">
  <table class="details">
    <tbody>
      ...
      <tr>
        <th>Template</th>
        <?php $tpl_url = url_for('imbra/approveConfirmation?member_id='. $member->getId() .'&id=' . $imbra->getId() . '&template_id=') ?>
