...
<?php if( count($blocks) > 0 ): ?>
	...
	<?php foreach ($blocks as $block): ?>
	    <tr>
	        ...
	        <td><?php echo link_to_unless(!$block->getMemberRelatedByProfileId()->isActive(), __('View Profile'), '@profile?bc=blocked&username=' . $block->getMemberRelatedByProfileId()->getUsername(), 'class=sec_link') ?></td>
