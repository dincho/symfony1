...
<?php echo form_tag('dashboard/emailNotifications', array('id' => 'deactivate')) ?>
    ...
    <?php echo pr_label_for('email_notifications_0', 'Each time there is an activity on my account (new message, wink, hot-list or profile view)') ?><br />
    ...
    <?php echo pr_label_for('email_notifications_no', 'Do not send me e-mail notifications about activity on my profile') ?><br />
