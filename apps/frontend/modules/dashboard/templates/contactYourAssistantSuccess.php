...
<?php echo form_tag('dashboard/contactYourAssistant', array('id' => 'report_bug')) ?>
    <fieldset>
        <div id="assistant_right">
            ...
            <?php echo link_to(__('I forgot my password'), '@page?slug=faqs#1', 'class=sec_link') ?><br />
            <?php echo link_to(__('I cannot contact other member, even though I\'m logged in.'), '@page?slug=faqs#2', 'class=sec_link') ?><br />
            <?php echo link_to(__('Special note to AOL users'), '@page?slug=faqs#3', 'class=sec_link') ?><br />
            <?php echo link_to(__('How do I sing up?'), '@page?slug=faqs#4', 'class=sec_link') ?><br />
            <?php echo link_to(__('How do I unsubscribe?'), '@page?slug=faqs#5', 'class=sec_link') ?><br />
            <?php echo link_to(__('Can I delete my account?'), '@page?slug=faqs#6', 'class=sec_link') ?><br />
