...
<?php echo __('If you\'re not a member, please ') . link_to(__('sign up for free now'), 'registration/joinNow') . __(' or ') . link_to(__('go to home page.'), '@homepage',  array('class' => 'sec_link'));?>