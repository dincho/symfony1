    ...
    <div class="you_recived">
        ...
        <?php foreach ($others_hotlists as $others_hotlist_row): ?>
            ...
            <div class="member_profile">
                ...
                <?php echo link_to_unless_ref(!$member->isActive(), profile_photo($member, 'float-left'), '@profile?bc=hotlist&username=' . $member->getUsername()) ?>
                <div class="input">
                    ...
                    <?php echo link_to_unless_ref(!$member->isActive(), __('View Profile'), '@profile?bc=hotlist&username=' . $member->getUsername(), array('class' => 'sec_link')) ?>
                </div>
            </div>        
        <?php endforeach; ?>
    </div>
    <div class="you_sent">
        ...
        <?php foreach ($hotlists as $hotlist_row): ?>
            ...
            <div class="member_profile">
                ...
                <?php echo link_to_unless_ref(!$profile->isActive(), profile_photo($profile, 'float-left'), '@profile?bc=hotlist&username=' . $profile->getUsername()) ?>
                <div class="input">
                    ...
                    <?php echo link_to_unless_ref(!$profile->isActive(), __('View Profile'), '@profile?bc=hotlist&username=' . $profile->getUsername(), array('class' => 'sec_link')) ?><br />
