...
<div id="right">
    ...
    <?php else: ?>
        ...
        <p><?php echo pr_link_to('Member Stories', 'memberStories/index') ?>&bull;<?php echo pr_link_to('Report a bug', 'content/reportBug') ?>&bull;<?php echo link_to_unless( $sf_context->getModuleName() == 'content' && $sf_request->getParameter('slug') == 'help', 'Help', '@page?slug=help', 'class=last') ?></p>
    <?php endif; ?>
</div>