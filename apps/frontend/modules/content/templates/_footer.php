<div id="footer">
    ...
    <span class="footer_footer"><?php echo link_to('&copy; Copyright 2007-2008 by PolishRomance.com ', '@page?slug=copyright') ?>- Patent Pending - All Rights Reserved - <?php include_partial('system/page_execution'); ?></span>
</div>