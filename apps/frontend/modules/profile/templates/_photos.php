<?php $photoRestrictionError = isset($photoRestrictionError) ? $photoRestrictionError : '' ?>
<?php $i=1;foreach ($photos as $photo): ?>
    ...
    <?php $show_profile_image = sprintf('show_profile_image("%s", %d, "%s", "lightbox[%s]", "%s")', $photo->getImg('350x350', 'file'), $photo->getId(), $photo->getImg(null, 'file'), $block_id, $photoRestrictionError); ?>
