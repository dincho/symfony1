...
<form action="<?php echo url_for('search/' . sfContext::getInstance()->getActionName()) ?>" id="search_box" class="public_matches">
    <table border="0" cellpadding="0" cellspacing="0" class="search_filter">
	    <tbody>
		    <tr class="tr_1">
		        <td class="td_1"><?php echo __('You are') ?></td>
		    ...
		    <tr>
		        <td colspan="5" class="td_2"></td>
		    </tr>
		    <tr class="tr_1">
		        <td class="td_3"><strong><?php echo __('Location') ?></strong></td>
		    ...
		    <tr class="tr_1">
		        ...
		        <td class="td_4"><?php echo link_to(__('Select Countries'), 'search/selectCountries') ?></td>
		        <td></td>
		        <td class="td_4"><?php echo link_to(__('Select Cities'), 'search/selectAreas?country=PL&polish_cities=1') ?></td>
		    </tr>
		    <tr>
		        <td colspan="5" class="td_5" ><?php echo submit_tag(__('Search'), array('class' => 'button','name' => 'filter', 'onclick' => "show_loader('match_results')")) ?></td>
