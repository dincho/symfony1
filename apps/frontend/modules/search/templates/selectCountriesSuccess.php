...
<form action="<?php echo url_for('search/selectCountries')?>" id="countries" method="post">
    ...
    <fieldset class="fieldcountry">
        ...
        <label>
            ...
            <?php if( in_array('US', $sf_data->getRaw('states')) ): ?>
        ...
        <label>
            ...
            <?php if( in_array('PL', $sf_data->getRaw('states')) ): ?>
        ...
        <label>
            ...
            <?php if( in_array('GB', $sf_data->getRaw('states')) ): ?>
        ...
        <label>
            ...
            <?php if( in_array('IE', $sf_data->getRaw('states')) ): ?>
        ...
        <label>
            ...
            <?php if( in_array('CA', $sf_data->getRaw('states')) ): ?>
