...
<form action="<?php echo url_for('search/selectCountries')?>" id="countries" name="countries_form" method="post">
    ...
    <?php echo button_to(__('Cancel and return to search'), $sf_user->getRefererUrl(), array('class' => 'button')) ?><br /><br /><br />
    ...
    <?php echo button_to(__('Cancel and return to search'), $sf_user->getRefererUrl(), array('class' => 'button')) ?>
</form>
