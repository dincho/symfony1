<?php if( !is_null($question->getOther()) ): ?>
    <?php echo checkbox_tag('answers['. $question->getid() .']', 'other', fillIn( 'answers['. $question->getid() .']', 'r', false, isset($member_answers[$question->getId()]) && !is_null($member_answers[$question->getId()]->getOther()) ), array('class' => 'zodiac', 'id' => 'others_check_' . $question->getId()) ) ?>
