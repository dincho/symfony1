...
<?php echo __('Manage subscription - membership status', array('%SUBSCRIPTION_TYPE%' => ($member_subscription) ? $member_subscription->getSubscription()->getTitle() : $member->getSubscription()->getTitle() )); ?>
