...
<?php if( $member->getLastPaypalItem() == 'membership'): ?>
    ...
    <?php if( is_null($member->getPaypalUnsubscribedAt()) ): ?>
        ...
        <br /><?php echo button_to(__('Unsubscribe'), sfConfig::get('app_paypal_url') . '?cmd=_subscr-find&alias=' . urlencode(sfConfig::get('app_paypal_business')), array('popup' => true, 'class' => 'button')) ?>    
    <?php else: ?>
