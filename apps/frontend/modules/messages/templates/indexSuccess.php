...
<?php echo form_tag('messages/delete', array('id' => 'messages_form', 'name' => 'messages_form')) ?>
    ...
    <?php echo ( $message->getIsRead() ) ? '<tr>' : '<tr class="bold">'; ?>
        <td class="checkboxes"><?php echo checkbox_tag('selected[]', $message->getId(), false, array('class' => 'checkbox', 'read' => (int) $message->getIsRead())) ?></td>
...
<?php echo form_tag('messages/delete', array('id' => 'messages_form_sent', 'name' => 'messages_form_sent', 'style' => 'display: none;')) ?>    
