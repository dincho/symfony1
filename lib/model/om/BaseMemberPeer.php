...
abstract class BaseMemberPeer {
	...
	const DASHBOARD_MSG = 'member.DASHBOARD_MSG';

	
	const IMBRA_PAYMENT = 'member.IMBRA_PAYMENT';

	
	const ORIGINAL_FIRST_NAME = 'member.ORIGINAL_FIRST_NAME';

	
	const ORIGINAL_LAST_NAME = 'member.ORIGINAL_LAST_NAME';

	
	const LAST_SUBSCRIPTION_CHANGE = 'member.LAST_SUBSCRIPTION_CHANGE';
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(MemberPeer::LAST_IP);
		...
		$criteria->addSelectColumn(MemberPeer::DASHBOARD_MSG);

		$criteria->addSelectColumn(MemberPeer::IMBRA_PAYMENT);

		$criteria->addSelectColumn(MemberPeer::ORIGINAL_FIRST_NAME);

		$criteria->addSelectColumn(MemberPeer::ORIGINAL_LAST_NAME);

		$criteria->addSelectColumn(MemberPeer::LAST_SUBSCRIPTION_CHANGE);
