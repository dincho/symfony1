...
abstract class BaseMemberPeer {
	...
	const CONFIRMED_EMAIL = 'member.CONFIRMED_EMAIL';
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(MemberPeer::CONFIRMED_EMAIL);
