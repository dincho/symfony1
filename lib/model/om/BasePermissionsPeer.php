...
abstract class BasePermissionsPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Permissions';
	...
	{
		include_once 'lib/model/map/PermissionsMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.PermissionsMapBuilder');
	}
	...
	public static function doCountJoinUser(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(PermissionsPeer::ID, UserPeer::ID);
	...
	public static function doSelectJoinUser(Criteria $c, $con = null)
	{
		...
		$c->addJoin(PermissionsPeer::ID, UserPeer::ID);
	...
	public static function doSelectJoinAll(Criteria $c, $con = null)
	{
		...
		GroupsPeer::addSelectColumns($c);
		$startcol4 = $startcol3 + GroupsPeer::NUM_COLUMNS;
		...
		while($rs->next()) {
			...
			for ($j=0, $resCount=count($results); $j < $resCount; $j++) {
				$temp_obj1 = $results[$j];
				$temp_obj3 = $temp_obj1->getGroups(); 				if ($temp_obj3->getPrimaryKey() === $obj3->getPrimaryKey()) {
					$newObject = false;
					$temp_obj3->addPermissions($obj1); 					break;
				}
			}

			if ($newObject) {
				$obj3->initPermissionss();
				$obj3->addPermissions($obj1);
			}
	...
	public static function doCountJoinAllExceptGroups(Criteria $criteria, $distinct = false, $con = null)
	{
				$criteria = clone $criteria;
	...
	public static function doSelectJoinAllExceptGroups(Criteria $c, $con = null)
	{
		$c = clone $c;
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/PermissionsMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.PermissionsMapBuilder');
}
